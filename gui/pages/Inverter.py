...
class Inverter(Screen):
    def __init__(self, **kwargs):
        ...
        inverter_value_layout = BoxLayout(
        ...
        motor_temp_container = BoxLayout(
            orientation="vertical", spacing=5, size_hint=(1, 0.5)
        )
        ...
        right_content = BoxLayout(
            orientation="vertical", spacing=10, size_hint=(0.5, 1)
        )
        ...
        self.warn_content_layout = BoxLayout(
            orientation="vertical", spacing=10, size_hint_y=None
        )
        self.warn_content_layout.bind(
            minimum_height=self.warn_content_layout.setter("height")
        )
