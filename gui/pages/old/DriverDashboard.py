...
class DriverDashboard(Screen):
    def __init__(self, **kwargs):
        ...
        self.last_lap_time_label = Label(
            text="Last Lap: --:--:--",
            font_size="35sp",
            bold=True,
            color=(1, 1, 1, 1),
        ...
        self.lapsleft_label = Label(
            text="Laps Left:",
            size_hint=(0.4, 0.1),
            pos_hint={"x": 0.03, "y": 0.60},
            font_size="35sp",
        )
        self.lapsleftvalue_label = Label(
            text="0",
            size_hint=(0.2, 0.1),
        ...
        self.inverter_label = Label(
            text="INVERTER TEMP", font_size="25sp", color=(0, 1, 1, 1), halign="center"
        )
        self.inverter_temp = Label(
            text="000 C", font_size="30sp", color=(1, 1, 1, 1), halign="center"
        )
        ...
        self.bestlap_label = Label(
            text="BEST LAP:",
            font_size="24sp",
            bold=True,
            color=(0, 1, 1, 1),
            size_hint=(0.2, 0.05),
            pos_hint={"x": 0.18, "y": 0.87},
        )
        self.bestlap_time_label = Label(
            text="--:--:--",
            font_size="24sp",
            bold=False,
            color=(1, 0, 1, 1),
            size_hint=(0.4, 0.05),
            pos_hint={"x": 0.38, "y": 0.869},
        )
        ...
        lap_times_grid = GridLayout(
            cols=3, spacing=10, size_hint=(0.9, 0.3), pos_hint={"x": 0.05, "y": 0.5}
        )

        # Add headers
        lap_times_grid.add_widget(
            Label(text="Lap", font_size="20sp", bold=True, color=(0, 1, 1, 1))
        )
        lap_times_grid.add_widget(
            Label(text="Time", font_size="20sp", bold=True, color=(1, 1, 1, 1))
        )
        lap_times_grid.add_widget(
            Label(text="% Used", font_size="20sp", bold=True, color=(1, 1, 1, 1))
        )
        ...
        self.batter_label = Label(
            text="Battery:",
            font_size="29sp",
            size_hint=(0.4, 0.1),
            pos_hint={"x": -0.35, "y": 0.4},
        )
        self.soc_label = Label(
            text="100%",
            font_size="29sp",
            size_hint=(0.4, 0.1),
            pos_hint={"x": -0.15, "y": 0.4},
        )
        self.avgenergy_label = Label(
            text="Average Energy Used:",
            font_size="15sp",
            size_hint=(0.4, 0.1),
            pos_hint={"x": 0.1, "y": 0.4},
        )
        self.avgenergyprocent_label = Label(
            text="0%", size_hint=(0.4, 0.1), pos_hint={"x": 0.3, "y": 0.4}
        )
    ...
    def refresh(self):
        ...
        self.avgeng(
            self.time_table_manager.energy_data, self.time_table_manager.lap_times
        )
        ...
        best_lap, all_time_best_lap, lap_times, energy_data = (
            self.time_table_manager.add_lap_time(new_lap_time, soc_used)
        )
        ...
        if all_time_best_lap:
            self.bestlap_time_label.text = (
                f"{self.time_table_manager.format_time(all_time_best_lap)}"
            )
        ...
        self.last_lap_time_label.color = (
            (0, 1, 0, 1) if last_lap_color == "green" else (1, 1, 0, 1)
        )
        self.last_lap_time_label.text = f"Last Lap: {self.format_time(new_lap_time)}"
        publish_message(
            can.Message(arbitration_id=0x181, data=[0x49, 0x13, 0x25, 0x00])
        )
